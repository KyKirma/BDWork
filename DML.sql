...
INSERT INTO flor(categoria_id, nome_flor, descricao, estoque_disponivel, preco) VALUES
    ...
    (4, 'Buquê', 'P Vendida em forma de buquê ou unitária', 13, 150.00),
    (4, 'Buquê', 'M Vendida em forma de buquê ou unitária', 7, 250.00),
    (4, 'Buquê', 'G Vendida em forma de buquê ou unitária', 1, 350.00),

    (5, 'Buquê', 'P Vendida em forma de buquê ou unitária', 13, 150.00),
    (5, 'Buquê', 'M Vendida em forma de buquê ou unitária', 7, 250.00),
    (5, 'Buquê', 'G Vendida em forma de buquê ou unitária', 1, 350.00);
